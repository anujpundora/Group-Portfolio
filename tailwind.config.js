  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        conversion: {
          DEFAULT: "var(--color-conversion)", // coral
        ...
        cta: {
          DEFAULT: "var(--color-cta)", // amber-400
          foreground: "var(--color-cta-foreground)", // slate-900
        },
        brand: {
          primary: "var(--color-brand-primary)", // green-400
          secondary: "var(--color-brand-secondary)", // indigo-500
        },
      },
      borderRadius: {
        lg: "var(--radius)",
